...
export function useChartColors() {
  ...
  return {
    ...
    gridColor: isDark ? '#26262b' : '#e5e7eb',        // hairline, one shade off surface
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: isDark ? '#2e2e34' : '#e5e7eb',
      ...
      <LineChart data={rows} margin={{ top: 10, right: 20, left: 0, bottom: 5 }}>
        ...
        {series.map((s) => (
          <Line
            ...
            activeDot={{ r: 5, strokeWidth: 2, stroke: c.isDark ? '#141417' : '#ffffff' }}
